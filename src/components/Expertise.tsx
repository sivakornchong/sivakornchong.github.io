    ...
    <div className="container" id="expertise">
        <div className="skills-container">
            <h1>Career Summary</h1>
                <p>I'm a machine learning engineer with experience working in TikTok (Singapore) and leading a technical data&ML team at Sixone Labs (Canada). I have 8 years of experience in data and machine learning fields, with 2.5 years of leadership experience.</p>
